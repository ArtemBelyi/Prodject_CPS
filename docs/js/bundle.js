...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_sliders_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
...
function script() {
  ...
  function addSliderPrice(arr, container, classNameBlock, classNameElement) {
    for (var i = 0; i < arr.length; i++) {
      ...
      elem.classList.add(classNameBlock);
      elem.classList.add(classNameElement);
      elem.innerHTML = "\n            <div class=\"swiper-slide__price-content\">\n                <div class=\"swiper-slide__elem price-title\"><span class=\"price-title__text\">\u0420\u0435\u043C\u043E\u043D\u0442\u043D\u044B\u0435 \u0443\u0441\u043B\u0443\u0433\u0438</span><br>".concat(arr[i].name, "</div>\n                <div class=\"swiper-slide__elem price-title\"><span class=\"price-title__text\">\u0426\u0435\u043D\u0430</span><br>").concat(arr[i].price, "</div>\n                <div class=\"swiper-slide__elem price-title\"><span class=\"price-title__text\">\u0421\u0440\u043E\u043A</span><br>").concat(arr[i].term, "</div>\n                <button class=\"swiper-slide__elem elem-price-services\"> \u0417\u0410\u041A\u0410\u0417\u0410\u0422\u042C <i class=\"fa fa-chevron-right fa-chevron-right__price\" aria-hidden=\"true\"></i></button>\n            </div>\n            ");
      container.append(elem);
    }
...
function sliders() {
  var swiperBrands = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.brands-container', {
    pagination: {
      el: '.swiper-pagination'
    },
    scrollbar: {
  ...
  var swiperServices = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.services-container', {
    pagination: {
      el: '.swiper-pagination'
    },
    scrollbar: {
  ...
  var swiperPrice = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.price-container', {
    pagination: {
      el: '.swiper-pagination'
    },
    scrollbar: {
